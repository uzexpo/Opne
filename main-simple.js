...
function startPythonServer() {
  return new Promise((resolve, reject) => {
    ...
    const serverPath = path.join(__dirname, 'simple_server.py');
    
    // Проверяем существование файла
    if (!fs.existsSync(serverPath)) {
      reject(new Error('Файл simple_server.py не найден!'));
      return;
    }
...
console.log('🔧 main-simple.js загружен и готов к работе!'); 